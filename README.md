...
## 홈페이지 구조
<img width="500" height="auto" alt="image" src="https://github.com/user-attachments/assets/958bd923-ac71-4a58-a261-7fcc49d018ac" />
...
## 페이지 구성 
### 메인 페이지 화면<br>
- 해당 화면 상단에 메뉴바가 있고, 이 메뉴바의 다른 메뉴들을 클릭하면 해당 페이지로 이동한다.(ex. 구단 소개 메뉴 클릭시 구단 소개 페이지로 이동)
